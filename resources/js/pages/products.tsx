...
// Data Products (15 contoh data)
const products = Array.from({ length: 15 }, (_, i) => ({
    id: i + 1,
    name: `Produk ${i + 1}`,
    category: `Kategori ${Math.ceil((i + 1) / 5)}`, // Setiap 5 produk dalam 1 kategori
    price: (i + 1) * 10000, // Harga contoh
}));
...
export default function Products() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Products" />
            <div className="p-4">
                <h1 className="text-2xl font-bold mb-4">Daftar Products</h1>
